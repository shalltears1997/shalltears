...
(cl:in-package ros_master_test-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <Wrc201Msg-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Wrc201Msg-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_master_test-srv:<Wrc201Msg-request> is deprecated: use ros_master_test-srv:Wrc201Msg-request instead.")))

(cl:ensure-generic-function 'addr-val :lambda-list '(m))
(cl:defmethod addr-val ((m <Wrc201Msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_master_test-srv:addr-val is deprecated.  Use ros_master_test-srv:addr instead.")
  (addr m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <Wrc201Msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_master_test-srv:data-val is deprecated.  Use ros_master_test-srv:data instead.")
  (data m))

(cl:ensure-generic-function 'length-val :lambda-list '(m))
(cl:defmethod length-val ((m <Wrc201Msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_master_test-srv:length-val is deprecated.  Use ros_master_test-srv:length instead.")
  (length m))

(cl:ensure-generic-function 'cmd-val :lambda-list '(m))
(cl:defmethod cmd-val ((m <Wrc201Msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_master_test-srv:cmd-val is deprecated.  Use ros_master_test-srv:cmd instead.")
  (cmd m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Wrc201Msg-request>)))
  ...
  "ros_master_test/Wrc201MsgRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Wrc201Msg-request)))
  "Returns string type for a service object of type 'Wrc201Msg-request"
  "ros_master_test/Wrc201MsgRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <Wrc201Msg-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Wrc201Msg-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_master_test-srv:<Wrc201Msg-response> is deprecated: use ros_master_test-srv:Wrc201Msg-response instead.")))

(cl:ensure-generic-function 'readData-val :lambda-list '(m))
(cl:defmethod readData-val ((m <Wrc201Msg-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_master_test-srv:readData-val is deprecated.  Use ros_master_test-srv:readData instead.")
  (readData m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Wrc201Msg-response>)))
  ...
  "ros_master_test/Wrc201MsgResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Wrc201Msg-response)))
  "Returns string type for a service object of type 'Wrc201Msg-response"
  "ros_master_test/Wrc201MsgResponse")
